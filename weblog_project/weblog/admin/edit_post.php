        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form method="post" class="mb-5" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">نام پست را وارد کنید.</small>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="category">متن پست : </label>
                    <textarea class="form-control" name="body" id="body" rows="3">
                        <?php echo $post['body'] ?>
                    </textarea>
                    <small class="form-text text-muted">متن پست را وارد کنید.</small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">تصویر پست را وارد کنید.</small>
                </div>
